    ...
    def draw_polygons(self):
        ...
        while point < len(matrix[0]) - 1:
            if dot_product(normal(matrix, point), self.view_vector) >= 0:
                ...
                self.fill_triangle(point, color)
                self.draw_line( int(matrix[0][point]), int(matrix[1][point]), int(matrix[2][point]),
                                int(matrix[0][point+1]),int(matrix[1][point+1]), int(matrix[2][point+1]),
                                color)
                self.draw_line( int(matrix[0][point]), int(matrix[1][point]), int(matrix[2][point]),
                                int(matrix[0][point+2]),int(matrix[1][point+2]), int(matrix[2][point+2]),
                                color)
                self.draw_line( int(matrix[0][point+2]), int(matrix[1][point+2]), int(matrix[2][point+2]),
                                int(matrix[0][point+1]),int(matrix[1][point+1]), int(matrix[2][point+1]),
                                color)
            point += 3
